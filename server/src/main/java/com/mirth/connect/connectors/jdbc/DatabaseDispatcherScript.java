    ...
    private class DatabaseDispatcherTask extends JavaScriptTask<Object> {
        ...
        public Object doCall() {
            ...
            try {
                ...
                eventController.dispatchEvent(new ErrorEvent(connector.getChannelId(), connector.getMetaDataId(), connectorMessage.getMessageId(), ErrorEventType.DESTINATION_CONNECTOR, connector.getDestinationName(), connectorProperties.getName(), "Error evaluating " + connectorProperties.getName(), e, connectorMessage.getMessageIncarnationId()));
            } finally {
                Context.exit();
            }
